...
public class Menu {
    ...
    int BTN_COLOR = Color.parseColor("#0021FF");
    int BTN_COLOR2 = Color.parseColor("#00A0FF");
    int INPUT_COLOR = Color.parseColor("#5D00FF");
    int INPUTV_COLOR = Color.parseColor("#5D00FF");
    ...
    int BtnON = Color.parseColor("#801b5e20");
    int BtnOFF = Color.parseColor("#807f0000");  
    int CategoryBG = Color.parseColor("#FF0000");
    int CollapseBG = Color.parseColor("#D57117");
    int SeekBarColor = Color.parseColor("#FF0000");
    ...
    loader = new Loader(context);
        loader.startUp();
        loader.hide();
        loader.getExecuter().setOnCloseListener(new Executer.onCloseListener() {
            @Override
            public void onClose() {
    ...
    button.setOnClickListener(new View.OnClickListener() {
        public void onClick(View v) {
            button.setBackgroundColor(BTN_COLOR2);
    ...
    if (isOn) {
        ...
        border.setColor(BtnON);
        isOn = false;
    } else {
        button.setText(Html.fromHtml(finalfeatName + " 𓏵"));
        border.setColor(BtnOFF);
        isOn = true;
    }
    ...
    button.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (isOn) {
                button.setText(Html.fromHtml(finalfeatName + " ✓"));
                border.setStroke(5, Color.parseColor("#00F4FF"));
                border.setColor(BtnON);
                isOn = false;
            } else {
                button.setText(Html.fromHtml(finalfeatName + " 𓏵"));
...
editText.setFocusable(false);
    ...
    private void Collapse(LinearLayout linLayout, final String text, final boolean expanded) {
        ...
        final TextView textView = new TextView(getContext);
        textView.setBackgroundColor(CollapseBG);
